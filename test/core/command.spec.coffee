...
describe 'command', ->
  ...
  describe '#run', ->
    ...
    it 'should trigger #pipe on each given module', sinon.test ->
      ...
      command.run null, { cmd: 'test' }, modules : [ pipe : initSpy ], events: subscribe: ->
